...
```bash
WORLD_MODEL_IMPL=/abs/path/to/your/index.ts npx tsx runner.ts
```

On Windows, use forward slashes and an absolute path. The module must export a `WorldModel` class plus `entityIdFromName`, `normalizeName`, and `decide`.
